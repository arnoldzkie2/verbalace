...
const Main: React.FC<MainProps> = ({ }) => {
    ...
    return (
        <main className="bg-[url(/web/home.svg)] z-10 bg-center bg-no-repeat bg-cover flex-col md:flex-row gap-10 px-5 pt-24 md:pt-0 sm:px-10 md:px-16 lg:px-24 xl:px-36 2xl:px-44 w-screen sm:h-screen flex items-center" id='home'>
            <div className='flex flex-col gap-4 w-full md:gap-5 text-center md:text-left px-3 md:px-0 items-center md:items-start'>
