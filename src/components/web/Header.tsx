...
const Header: React.FC<HeaderProps> = ({ }) => {
    ...
    return (
        <header className={`z-10 px-5 sm:px-10 md:px-16 lg:px-24 xl:px-36 2xl:px-44  h-16 fixed w-screen transition duration-100 flex items-center top-0 left-0 justify-between ${scroll ? 'text-gray-700 bg-white shadow-lg' : 'text-white bg-transparent'}`}>
