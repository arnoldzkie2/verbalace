...
const About: React.FC = ({ }) => {
    ...
    return (
        <section className='py-24 px-5 sm:px-10 md:px-16 lg:px-24 xl:px-36 2xl:px-44 flex items-center gap-10 md:gap-16 text-gray-700 flex-col' id='about'>
            ...
            <div className='flex flex-col gap-5 sm:gap-10 md:gap-16 xl:gap-20 items-center xl:items-end 2xl:flex-row lg:justify-between'>
                <video controls className='w-auto h-auto 2xl:w-2/3 2xl:h-2/3' poster='/web/about/about-poster.webp'>
                ...
                <aside className='flex flex-col 2xl:w-1/2 items-center md:items-start gap-5 lg:gap-7 text-gray-600'>
                    <h1 className='text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light lg:font-extralight mb-5 pb-5 border-b hidden 2xl:block'>{t('h1')}</h1>
